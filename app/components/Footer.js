...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="py-5 overflow-hidden bg-neutral-100">
      <p ref={textRef} className="invisible text-xs text-center text-neutral-700 sm:text-sm">Copyright &copy; <span className="font-medium">Rahil Bin Mushfiq</span>. All Rights Reserved</p>
    </footer>
  );
}
