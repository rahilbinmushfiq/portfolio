...
export default function Contact() {
  return (
    <>
      <section id="contact" className="overflow-hidden sm:flex sm:h-[calc(100vh_-_(80px_+_60px))] sm:[&>div]:h-full sm:[&>div]:w-min lg:h-[calc(100vh_-_(86px_+_60px))] 3xl:h-[calc(100vh_-_(86px_+_64px))]">
