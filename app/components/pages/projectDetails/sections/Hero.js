...
export default function Hero({ heroSectionRef, projectTitle, projectSummary, projectDemoLink, projectCodeLink }) {
  return (
    <section ref={heroSectionRef}>
      ...
      <div className="mt-7 flex gap-x-3 [&>button]:project-page-btn">
        ...
        {!!projectCodeLink && <button className="text-primary-base hover:text-white hover:bg-primary-light">
      ...
      {/* NDA notice */}
      {!projectCodeLink && <p className="mt-3 text-neutral-500 text-[13px]">*Source code not available due to NDA</p>}
    </section>
  );
}
